		...
		%>
			<tr>
				...
				<td>
					...
					%>
						<input type="checkbox" id="parada_<%=parada.getOrden()%>">
						<label for="parada_<%=parada.getOrden()%>">Llegué</label>
					<%
						}
					%>
...
<div class="col s12">
	<input class="btn btn-primary" type="button" value="Reportar siguiente parada">
</div>
...
<script>
	$(document).ready(function() {
		$('input[type="checkbox"]}').change(function() {
			...
			$.post('reportarParada', {idParada: id});
		});
	});
</script>
