		...
		<div class="col s12 m4 l10 ">
			<div class="card">
				<div class="card-content white-text pink">
					<span class="card-title">Listado de Vehiculos</span>
				</div>
				...
				<div class="col s12">
					<ul class="tabs">
						<li class="tab col s3"><a class="active" href="#test1">Listar
								Locales</a></li>
						<li class="tab col s3"><a href="#test2">Listar Externos</a></li>
					</ul>
				</div>
				...
				<div id="test1">
					...
					<div class="card-content">
						<table>
							<thead>
								<tr>
									<th class="">ID Vehiculo</th>
									<th class="">ID Sucursal</th>
									<th data-field="name">Patente</th>
									<th data-field="item-name">Peso</th>
									<th data-field="price">Tara</th>
									<th class="">Tarifa</th>
									<th data-field="name">Ancho</th>
									<th data-field="item-name">Alto</th>
									<th data-field="price">Profundidad</th>
									<th data-field="name">Tipo</th>
									<th data-field="item-name">Alto</th>
									<th data-field="price">Profundidad</th>
									<th data-field="price">Vencimiento Garantía</th>
								</tr>
							</thead>
